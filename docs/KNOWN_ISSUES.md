...
### 14. Native macOS MPS Setup and Audio Dependencies
...
The Dockerfile installs `ffmpeg` only inside the image; that does not install
it on the host Mac.

### 15. Whisper Sparse Alignment Buffer on MPS
...
### 16. Docker Absolute Paths in Native Metadata
