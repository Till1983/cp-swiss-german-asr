...
`requirements_blackwell.txt` includes packages compatible with PyTorch 2.8+ for use of more powerful and compatible GPUs. This was important for the use of more powerful GPUs on RunPod during model evaluation and development.
