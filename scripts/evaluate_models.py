...
MODEL_REGISTRY = {
   ...
   "whisper-large-swiss": {
    ...
    "whisper-large-v2-swiss-german-baseline": {
        "type": "whisper-hf",
        "name": str(
            RESULTS_DIR / "runs" / "baseline" / "20260618_071457" / "checkpoint-1250"
            if ENVIRONMENT == "local"
            else RESULTS_DIR / "baseline" / "20260618_071457" / "checkpoint-1250"
        ),
    ...
    "whisper-large-v2-swiss-german-ewc-lambda-30000": {
     ...
     "whisper-large-v2-swiss-german-ewc-lambda-30000-step1260": {
         "type": "whisper-hf",
         "name": str(
             RESULTS_DIR / "runs" / "ewc" / "20260625_065143_lambda30000" / "checkpoint-1260"
             if ENVIRONMENT == "local"
             else RESULTS_DIR / "ewc" / "20260625_065143_lambda30000" / "checkpoint-1260"
         ),
         "processor_name": "openai/whisper-large-v2",
    },
    ...
    "whisper-large-v2-swiss-german-ewc-lambda-300000": {
         "type": "whisper-hf",
         "name": str(
             RESULTS_DIR / "runs" / "ewc" / "20260626_095508_lambda300000" / "checkpoint-750"
             if ENVIRONMENT == "local"
             else RESULTS_DIR / "ewc" / "20260626_095508_lambda300000" / "checkpoint-750"
         ),
         "processor_name": "openai/whisper-large-v2",
    },
    ...
    "whisper-large-v2-swiss-german-ewc-lambda-300000-step1260": {
        "type": "whisper-hf",
        "name": str(    
            RESULTS_DIR / "runs" / "ewc" / "20260626_095508_lambda300000" / "checkpoint-1260"
            if ENVIRONMENT == "local"
            else RESULTS_DIR / "ewc" / "20260626_095508_lambda300000" / "checkpoint-1260"
        ),
        "processor_name": "openai/whisper-large-v2",
    },
